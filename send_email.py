...
with open('test.txt', 'rb') as f:
    # 设置附件中的MIME和文件名
    mime = MIMEBase('text', 'text', filename='hope.txt')
    # 加上必要的头信息
    mime.add_header('Content-Disposition', 'attachment', filename='hope.txt')
...
smtp_port = 587                  # smtp.gmail.com:587
server = smtplib.SMTP_SSL(smtp_server, 465)   # 创建SMTP实例，默认端口是25
